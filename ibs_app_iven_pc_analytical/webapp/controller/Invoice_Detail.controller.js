sap.ui.define([
	...
	var selectedItem;
	var vendorAmt=[];
	return Controller.extend("com.ibs.ibsappivenpcanalytical.controller.Invoice_Detail", {
		formatter: formatter,
		onInit: function () {
			// debugger
			context = this;
			...
			if (validateData === true) {
				...
				if (!context._saveFragment) {
					context._saveFragment = sap.ui.xmlfragment(
						"com.ibs.ibsappivenpcanalytical.view.fragments.saveFragmentInvCreation",
						context
					);
