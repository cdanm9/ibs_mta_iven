		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PO Collaboration",
									"targetURL": "#comibsibsappivensaanalytical-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappivensaanalytical-display": {
								"semanticObject": "comibsibsappivensaanalytical",
								"action": "display",
								"description": "PO Collaborationm All Apps",
								"title": "PO Collaboration",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappivensaanalytical",
									"url": sap.ui.require.toUrl("com/ibs/ibsappivensaanalytical")
								}
							}
						}
					}
