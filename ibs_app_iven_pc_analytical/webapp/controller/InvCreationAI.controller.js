sap.ui.define([
    ...
    function (Controller, MessageBox, JSONModel, formatter) {
        ...
        return Controller.extend("com.ibs.ibsappivenpcanalytical.controller.InvCreationAI", {  
            formatter: formatter,
            ...
            onCreate: function(){
                var that = this;
                if (!that.filterfrag) {
                    that.filterfrag = sap.ui.xmlfragment("com.ibs.ibsappivenpcanalytical.view.fragments.uploadFile", that);      
