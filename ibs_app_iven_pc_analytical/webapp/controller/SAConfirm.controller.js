sap.ui.define([
	...
	return Controller.extend("com.ibs.ibsappivenpcanalytical.controller.SAConfirm", {
        formatter: formatter,
		onInit: function () {
		...
		onQuanPress: function (e) {
			...
			var that = this;
			if (!this.QuantFrag) {
				this.QuantFrag = sap.ui.xmlfragment("com.ibs.ibsappivenpcanalytical.view.fragments.SAReqQtyFrag", this);
