sap.ui.define([
	...
	"sap/m/MessageBox",
	"com/ibs/ibsappivenpcanalytical/model/formatter",
	...
	return Controller.extend("com.ibs.ibsappivenpcanalytical.controller.PODetails", {
		formatter: formatter,
		onInit: function () {
            debugger
			...
			if (selectKey === "03") {
				...
				if (!this.ViewCPO) {
					this.ViewCPO = sap.ui.xmlfragment(
						"com.ibs.ibsappivenpcanalytical.view.fragments.changePO", this
					);
		...
		showchngPoItem: function (oEvent) {
			...
			if (!this.eViewCPO) {
				this.eViewCPO = sap.ui.xmlfragment(
					"com.ibs.ibsappivenpcanalytical.view.fragments.EditChngPO", this
				);
		...
		onSubmitPress: function () {
			...
			if (!context._saveFragment) {
				context._saveFragment = sap.ui.xmlfragment(
					"com.ibs.ibsappivenpcanalytical.view.fragments.saveChange",
					context
				);
				...
				if (data[i].code === "POC/001") {
					...
					if (!this.eAction) {
						this.eAction = sap.ui.xmlfragment(
							"com.ibs.ibsappivenpcanalytical.view.fragments.errorHandle",
							this
						);
