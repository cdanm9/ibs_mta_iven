sap.ui.define([
    ...
    var num = 0;
    var count1;
	return Controller.extend("com.ibs.ibsappivensaanalytical.controller.POEntriesReportByr", {
		formatter: formatter,
		onInit: function () {
           ...
           BusyIndicator.show(0);
			...
			this.oModel2 = this.getOwnerComponent().getModel("oDataModelPOReportByr");
			// this.oModel1 = this.getOwnerComponent().getModel("CloudXsOdata");
			sKey = this.getView().byId("idIconTabBar").getSelectedKey();
			var oRouter = this.getOwnerComponent().getRouter().getRoute("po_report_byr");   
		...
		handleValueHelpPONo: function (oEvent) {
            ...
            if (!this._valueHelpDialog) {
                this._valueHelpDialog = sap.ui.xmlfragment("com.ibs.ibsappivensaanalytical.view.fragments.PoNumber",this);
