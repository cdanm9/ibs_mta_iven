		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappivenpcanalytical-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappivenpcanalytical-display": {
								"semanticObject": "comibsibsappivenpcanalytical",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappivenpcanalytical",
									"url": sap.ui.require.toUrl("com/ibs/ibsappivenpcanalytical")
								}
							}
						}
					}
